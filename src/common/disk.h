...
bool kdisk_save_mode_params(const std::vector<video_mode_params_s> &modeParams, const QString &targetFilename);
...
bool kdisk_save_filter_graph(std::vector<FilterGraphNode*> &nodes, const QString &targetFilename);

...
filtergui_input_gate_c::filtergui_input_gate_c(abstract_filter_c *const filter)
{
    ...
    width->isEnabled = filter->parameter(filter_input_gate_c::PARAM_IS_WIDTH_ENABLED);
    width->minValue = 0;
    ...
    height->isEnabled = filter->parameter(filter_input_gate_c::PARAM_IS_HEIGHT_ENABLED);
    height->minValue = 0;
    ...
    hz->isEnabled = filter->parameter(filter_input_gate_c::PARAM_IS_HZ_ENABLED);
    hz->minValue = 0;
    hz->maxValue = 1000;

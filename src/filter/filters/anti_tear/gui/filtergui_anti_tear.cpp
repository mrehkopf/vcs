...
{
    {
        ...
        scanDir->set_value = [=](const double value){filter->set_parameter(filter_anti_tear_c::PARAM_SCAN_DIRECTION, value);};
...

    {
        ...
        scanHint->set_value = [=](const double value){filter->set_parameter(filter_anti_tear_c::PARAM_SCAN_HINT, value);};
...

    {
        ...
        scanStart->set_value = [=](const double value){filter->set_parameter(filter_anti_tear_c::PARAM_SCAN_START, value);};
        ...
        scanEnd->set_value = [=](const double value){filter->set_parameter(filter_anti_tear_c::PARAM_SCAN_END, value);};
        scanEnd->minValue = 0;
...

    {
        ...
        threshold->set_value = [=](const double value){filter->set_parameter(filter_anti_tear_c::PARAM_THRESHOLD, value);};
...

    {
        ...
        windowSize->set_value = [=](const double value){filter->set_parameter(filter_anti_tear_c::PARAM_WINDOW_LENGTH, value);};
...

    {
        ...
        stepSize->set_value = [=](const double value){filter->set_parameter(filter_anti_tear_c::PARAM_STEP_SIZE, value);};
        stepSize->minValue = 1;
...

    {
        ...
        matches->set_value = [=](const double value){filter->set_parameter(filter_anti_tear_c::PARAM_MATCHES_REQD, value);};
        matches->minValue = 1;
...

    {
        ...
        tears->set_value = [=](const double value){filter->set_parameter(filter_anti_tear_c::PARAM_VISUALIZE_TEARS, value);};
        tears->label = "Tears";
        ...
        range->set_value = [=](const double value){filter->set_parameter(filter_anti_tear_c::PARAM_VISUALIZE_RANGE, value);};
        range->label = "Range";

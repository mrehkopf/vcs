...
filtergui_output_gate_c::filtergui_output_gate_c(abstract_filter_c *const filter)
{
    ...
    width->isEnabled = filter->parameter(filter_output_gate_c::PARAM_IS_WIDTH_ENABLED);
    width->minValue = 0;
    ...
    height->isEnabled = filter->parameter(filter_output_gate_c::PARAM_IS_HEIGHT_ENABLED);
    height->minValue = 0;

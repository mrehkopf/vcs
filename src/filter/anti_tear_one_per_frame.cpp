                                        ...
                                        const bool visualizeScanRange)
{
    switch (this->nextAction)
    {
        ...
        case next_action_e::copy_rest_of_pixel_data:
        {
            ...
            //////
            /// Intentionally fall through to scan for the next tear.
            //////
        }
        ...
        case next_action_e::scan_for_tear:
        {
            ...
            this->latestTearRow = this->base->find_tear_row(frame, this->scanStartRow, this->scanEndRow);

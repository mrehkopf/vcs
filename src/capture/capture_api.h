...
struct capture_api_s
{
    ...
    virtual uint                      get_current_input_channel_idx(void)       const = 0;
    ...
    virtual capturePixelFormat_e      get_pixel_format(void)                    const = 0;
    ...
    virtual void                    set_mode_params(const std::vector<video_signal_parameters_s> &modeParams) { (void)modeParams; return;       }
    virtual void                    assign_video_signal_parameters(const video_signal_parameters_s p)   { (void)p;          return;       }
    ...
    virtual bool                    change_resolution(const resolution_s &r)                            { (void)r;          return false; }
};
